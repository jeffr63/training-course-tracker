...
describe('Courses Actions', () => {
  ...
  describe('GetPaths', () => {
    it(`should create an action`, () => {
      const action = new fromActions.GetPaths();

      expect(action.type).toEqual(fromActions.CourseActionTypes.PATHS);
    });
  });

  describe('GetPathsFail', () => {
    it(`should create an action`, () => {
      const payload = 'Error';
      const action = new fromActions.GetPathsFail(payload);

      expect({ ...action }).toEqual({
        type: fromActions.CourseActionTypes.PATHS_FAIL,
        payload
      });
    });
  });

  describe('GetPathsSuccess', () => {
    it(`should create an action`, () => {
      const payload = ['ABC', 'DEF'];
      const action = new fromActions.GetPathsSuccess(payload);

      expect({ ...action }).toEqual({
        type: fromActions.CourseActionTypes.PATHS_SUCCESS,
        payload
      });
    });
  });
  ...
  describe('GetSources', () => {
    it(`should create an action`, () => {
      const action = new fromActions.GetSources();

      expect(action.type).toEqual(fromActions.CourseActionTypes.SOURCES);
    });
  });
  ...
  describe('GetSourcesFail', () => {
    it(`should create an action`, () => {
      const payload = 'Error';
      const action = new fromActions.GetSourcesFail(payload);

      expect({ ...action }).toEqual({
        type: fromActions.CourseActionTypes.SOURCES_FAIL,
        payload
      });
    });
  });
  ...
  describe('GetSourcesSuccess', () => {
    it(`should create an action`, () => {
      const payload = ['ABC', 'DEF'];
      const action = new fromActions.GetSourcesSuccess(payload);

      expect({ ...action }).toEqual({
        type: fromActions.CourseActionTypes.SOURCES_SUCCESS,
        payload
      });
    });
  });
